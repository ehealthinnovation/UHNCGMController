...
// UHNCGMController
#define COCOAPODS_POD_AVAILABLE_UHNCGMController
#define COCOAPODS_VERSION_MAJOR_UHNCGMController 0
#define COCOAPODS_VERSION_MINOR_UHNCGMController 1
#define COCOAPODS_VERSION_PATCH_UHNCGMController 2
